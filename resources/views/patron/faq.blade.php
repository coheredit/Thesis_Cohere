...
<div class="faq-container">
    ...
    <div class="faq">
            ...
            <div class="faq-answer">The only difference of both venuw is the capacity. Villa I can accommundate 
                up to 200 pax while Villa II can accommundate up to 300 pax. 
            </div>
        </div>
        ...
        <div class="faq">
            <button class="faq-question">Do you have a accredited Coordinator? <span class="arrow">&#9660;</span></button>
        ...
        <div class="faq">
            ...
            <div class="faq-answer">Yes! But make sure to inform your Account executive that you will 
                ...
                rules & regulations of bring pets in our facility. </div>
        </div>
        ...
        <div class="faq">
            ...
            <div class="faq-answer">Yes! Our clients have two options.
                ...
                at Villa il Option 2: Ceremony and Reception will be held in one venue either Villa | or Villa II </div>
        </div>
        ...
        <div class="faq">
            ...
            <div class="faq-answer"> Yes! Send us a email at villasaludcateringservices@gmail.com for qoutation. </div>
        </div>

        <div class="faq">
            <button class="faq-question">What occasion/event do you cater? <span class="arrow">&#9660;</span></button>
            <div class="faq-answer">We can cater all occasion like wedding, debut, anniversary party, gender reveal party, 
        ...
        <div class="faq">
            ...
            <div class="faq-answer">Yes! Send us a email at villasaludcateringservices@gmail.com for quotation and packages
            </div>
        </div>
</div>
@endsection
